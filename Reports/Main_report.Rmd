...
opts_knit$set(root.dir = "C://Users/am2609/Blood Cell Traits Data/Reports/")
...
for(i in seq(nrow(input))){
 keep[i, "estimate"]<- (list_save[[i]][[5]])@Estimate
 Up<-formatC(list_save[[i]][[5]]@CIUpper, format = "e", digits = 2)
Low<-formatC(list_save[[i]][[5]]@CILower, format = "e", digits = 2)
 keep[i, "95% CI"]<- paste("(",Up, ", ", Low, ")", sep="")
 keep[i, "pvalue"]<- (list_save[[i]][[5]])@Pvalue
